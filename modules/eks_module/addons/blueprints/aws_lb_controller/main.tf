...
module "aws_load_balancer_controller" {
  ...
  role_name_use_prefix          = try(var.aws_load_balancer_controller.role_name_use_prefix, false)
  ...
  policy_name_use_prefix  = try(var.aws_load_balancer_controller.policy_name_use_prefix, false)
