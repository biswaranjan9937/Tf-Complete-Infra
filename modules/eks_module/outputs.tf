...
output "id" {
  description = "EKS CLuster ID of AWS Cloud"
...
#   value = module.eks_managed_node_group.node_iam_role_name.name
# }

# output "node_iam_role_arn" {
#   value = module.eks_managed_node_group.node_iam_role_arn.arn
# }
################################################################################
# EKS Addons
################################################################################
